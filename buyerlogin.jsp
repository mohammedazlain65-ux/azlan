...
<head>
    ...
    <title>Customer Login - MarketHub</title>
    ...
    <div class="login-container">
        ...
        <div class="login-left">
            <div class="login-left-content">
                <h2>Welcome Back!</h2>
                <p>Login to access your account and start shopping amazing products from verified sellers.</p>
        ...
        <div class="login-right">
            ...
            <form action="buyerlogin" method="post" onsubmit="return validateForm()">
            ...
            <div class="register-link">
                Don't have an account? <a href="buyerReg.jsp">Register here</a>
            </div>
